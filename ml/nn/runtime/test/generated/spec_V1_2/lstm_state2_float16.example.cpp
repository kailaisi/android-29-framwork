...
namespace generated_tests::lstm_state2_float16 {
    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({-0.0371611f, 0.125073f, 0.411934f, -0.208605f}),
                            .dimensions = {1, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({-0.287121f, 0.148115f, 0.556837f, -0.388276f}),
                            .dimensions = {1, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({-0.15053082f, 0.09120187f, 0.24278517f, -0.12222792f}),
                            .dimensions = {1, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model = TestModelManager::get().add("lstm_state2_float16", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("lstm_state2_float16_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
