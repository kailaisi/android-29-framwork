    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({-0.03716109f, 0.12507336f, 0.41193449f, -0.20860538f}),
                            .dimensions = {1, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model = TestModelManager::get().add("lstm_state_float16", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("lstm_state_float16_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
