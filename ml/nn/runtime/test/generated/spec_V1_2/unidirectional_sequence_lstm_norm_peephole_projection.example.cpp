...
const auto dummy_test_model = TestModelManager::get().add("unidirectional_sequence_lstm_norm_peephole_projection", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("unidirectional_sequence_lstm_norm_peephole_projection_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
