    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({0.014899f, -0.0517661f, -0.143725f, -0.00271883f, 0.014899f, -0.0517661f, -0.143725f, -0.00271883f}),
                            .dimensions = {2, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model = TestModelManager::get().add("svdf_float16", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("svdf_float16_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
