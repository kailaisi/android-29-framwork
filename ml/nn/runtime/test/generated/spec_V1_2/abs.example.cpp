...
const auto dummy_test_model = TestModelManager::get().add("abs", get_test_model());
...
const auto dummy_test_model_relaxed = TestModelManager::get().add("abs_relaxed", get_test_model_relaxed());
...
const auto dummy_test_model_float16 = TestModelManager::get().add("abs_float16", get_test_model_float16());
