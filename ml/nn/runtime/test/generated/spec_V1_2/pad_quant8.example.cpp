...
const auto dummy_test_model = TestModelManager::get().add("pad_quant8", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("pad_quant8_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
