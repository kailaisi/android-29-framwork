    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({1.0f, 3.0f}),
                            .dimensions = {1, 2},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_float16", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_float16_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
