    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f}),
                            .dimensions = {4, 2},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({0.7f, 0.6f, 0.5f, 0.4f, 0.3f, 0.2f, 0.1f, 1.0f}),
                            .dimensions = {4, 2},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({0.5f, 0.6f, 0.7f, 0.8f, 0.5f, 0.6f, 0.7f, 0.8f}),
                            .dimensions = {4, 2},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({0.153335f, 0.542754f, 0.708602f, 0.742855f, 0.247581f, 0.835739f, 0.947797f, 0.958177f, 0.410892f, 0.672268f, 0.761909f, 0.829133f}),
                            .dimensions = {3, 1, 4},
                            .isIgnored = false,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({0.342275f, 0.883431f, 0.95593f, 0.975621f, 0.204939f, 0.806858f, 0.914849f, 0.934871f, 0.123236f, 0.373087f, 0.465377f, 0.51763f}),
                            .dimensions = {3, 1, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model_blackbox = TestModelManager::get().add("bidirectional_sequence_lstm_aux_input_blackbox", get_test_model_blackbox());
...
const auto dummy_test_model_blackbox_all_inputs_as_internal = TestModelManager::get().add("bidirectional_sequence_lstm_aux_input_blackbox_all_inputs_as_internal", get_test_model_blackbox_all_inputs_as_internal());
