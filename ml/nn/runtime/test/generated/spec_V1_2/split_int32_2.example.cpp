...
const auto dummy_test_model = TestModelManager::get().add("split_int32_2", get_test_model());
...
const auto dummy_test_model_relaxed = TestModelManager::get().add("split_int32_2_relaxed", get_test_model_relaxed());
