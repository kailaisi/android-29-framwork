...
const auto dummy_test_model = TestModelManager::get().add("lsh_projection_4_relaxed", get_test_model());
...
const auto dummy_test_model_all_tensors_as_inputs = TestModelManager::get().add("lsh_projection_4_relaxed_all_tensors_as_inputs", get_test_model_all_tensors_as_inputs());
