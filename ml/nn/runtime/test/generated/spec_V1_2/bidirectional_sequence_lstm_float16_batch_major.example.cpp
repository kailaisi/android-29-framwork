    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({-0.0806187f, 0.139077f, 0.400476f, -0.197842f, -0.0332076f, 0.123838f, 0.309777f, -0.17621f, -0.0490733f, 0.0739237f, 0.067706f, -0.0208124f}),
                            .dimensions = {1, 3, 4},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model_blackbox = TestModelManager::get().add("bidirectional_sequence_lstm_float16_batch_major_blackbox", get_test_model_blackbox());
...
const auto dummy_test_model_blackbox_all_inputs_as_internal = TestModelManager::get().add("bidirectional_sequence_lstm_float16_batch_major_blackbox_all_inputs_as_internal", get_test_model_blackbox_all_inputs_as_internal());
