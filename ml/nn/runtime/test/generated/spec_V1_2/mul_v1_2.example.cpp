    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({2.0f, 0.0001f, 3.5f}),
                            .dimensions = {3},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_INPUT,
                            .numberOfConsumers = 1,
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({2.001953125f, 0.0001000165f, 8.75f}),
                            .dimensions = {3},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("mul_v1_2", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("mul_v1_2_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<_Float16>({1.0f, 4.0f, 3.0f, 8.0f}),
                            .dimensions = {2, 2},
                            .isIgnored = false,
                            .lifetime = TestOperandLifeTime::SUBGRAPH_OUTPUT,
                            .numberOfConsumers = 0,
...
const auto dummy_test_model_2 = TestModelManager::get().add("mul_v1_2_2", get_test_model_2());
...
const auto dummy_test_model_all_inputs_as_internal_2 = TestModelManager::get().add("mul_v1_2_all_inputs_as_internal_2", get_test_model_all_inputs_as_internal_2());
...
const auto dummy_test_model_zero_sized = TestModelManager::get().add("mul_v1_2_zero_sized", get_test_model_zero_sized());
...
const auto dummy_test_model_zero_sized_relaxed = TestModelManager::get().add("mul_v1_2_zero_sized_relaxed", get_test_model_zero_sized_relaxed());
...
const auto dummy_test_model_zero_sized_quant8 = TestModelManager::get().add("mul_v1_2_zero_sized_quant8", get_test_model_zero_sized_quant8());
...
const auto dummy_test_model_zero_sized_float16 = TestModelManager::get().add("mul_v1_2_zero_sized_float16", get_test_model_zero_sized_float16());
