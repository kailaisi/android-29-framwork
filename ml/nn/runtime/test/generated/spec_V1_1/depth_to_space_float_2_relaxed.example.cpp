...
namespace generated_tests::depth_to_space_float_2_relaxed {
...
const auto dummy_test_model = TestModelManager::get().add("depth_to_space_float_2_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("depth_to_space_float_2_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
