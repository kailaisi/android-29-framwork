...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_float_1", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_float_1_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
