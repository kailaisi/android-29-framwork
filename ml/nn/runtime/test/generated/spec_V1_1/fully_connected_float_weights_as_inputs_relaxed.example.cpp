...
const auto dummy_test_model = TestModelManager::get().add("fully_connected_float_weights_as_inputs_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("fully_connected_float_weights_as_inputs_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
