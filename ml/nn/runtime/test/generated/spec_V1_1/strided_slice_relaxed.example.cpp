    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({1.0f, 3.0f}),
                            .dimensions = {1, 2},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
