...
const auto dummy_test_model = TestModelManager::get().add("space_to_depth_float_2_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("space_to_depth_float_2_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
