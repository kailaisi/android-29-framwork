    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({1.85284f, -0.0393656f, -0.127353f, 1.43115f, -0.302294f, -1.0402f, 0.655023f, -0.587614f, 1.72003f, 1.55816f, 0.667546f, 2.23663f, 0.0661516f, 0.290254f, 0.770222f, -0.346357f, -1.58197f, -0.850595f, -0.484224f, 0.949967f, -0.577263f, -0.871949f, 2.34132f, -0.104506f, -0.135965f, -0.985713f, 0.815147f, 1.03114f, -1.41915f, -0.515534f, -0.373639f, 1.42026f, -1.50604f, 0.673113f, 3.06139f, -0.388578f, -1.76707f, -0.315667f, -1.03815f, -0.343435f, 0.432787f, -1.41643f, 1.12944f, -0.175806f, -0.846415f, 1.40095f, 0.70832f, -1.46717f, 2.19562f, -2.61266f, -0.705383f, 1.26124f, 1.46545f, -2.35761f, 2.04494f, 1.23741f, -0.527402f, -0.39954f, -0.0128623f, 1.3644f, 0.985755f, -0.718118f, -0.1008f, 1.24327f}),
                            .dimensions = {1, 8, 8, 1},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
...
const auto dummy_test_model_all_tensors_as_inputs = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_tensors_as_inputs", get_test_model_all_tensors_as_inputs());
...
const auto dummy_test_model_all_tensors_as_inputs_all_inputs_as_internal = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_tensors_as_inputs_all_inputs_as_internal", get_test_model_all_tensors_as_inputs_all_inputs_as_internal());
...
const auto dummy_test_model_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_2", get_test_model_2());
...
const auto dummy_test_model_all_inputs_as_internal_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_inputs_as_internal_2", get_test_model_all_inputs_as_internal_2());
...
const auto dummy_test_model_all_tensors_as_inputs_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_tensors_as_inputs_2", get_test_model_all_tensors_as_inputs_2());
...
const auto dummy_test_model_all_tensors_as_inputs_all_inputs_as_internal_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_relaxed_all_tensors_as_inputs_all_inputs_as_internal_2", get_test_model_all_tensors_as_inputs_all_inputs_as_internal_2());
