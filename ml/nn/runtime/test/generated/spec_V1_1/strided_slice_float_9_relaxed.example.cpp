...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_float_9_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_float_9_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
