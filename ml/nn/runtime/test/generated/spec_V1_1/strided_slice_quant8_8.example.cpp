    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<uint8_t>({6, 5, 4}),
                            .dimensions = {1, 3},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_quant8_8", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_quant8_8_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
