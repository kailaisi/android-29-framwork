    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<uint8_t>({1, 2, 4, 5}),
                            .dimensions = {2, 2},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_quant8_9", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_quant8_9_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
