    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({6.0f, 5.0f, 4.0f}),
                            .dimensions = {1, 3},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("strided_slice_float_8_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("strided_slice_float_8_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
