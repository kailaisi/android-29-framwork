...
const auto dummy_test_model = TestModelManager::get().add("conv_1_h3_w2_SAME", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("conv_1_h3_w2_SAME_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
...
const auto dummy_test_model_all_tensors_as_inputs = TestModelManager::get().add("conv_1_h3_w2_SAME_all_tensors_as_inputs", get_test_model_all_tensors_as_inputs());
...
const auto dummy_test_model_all_tensors_as_inputs_all_inputs_as_internal = TestModelManager::get().add("conv_1_h3_w2_SAME_all_tensors_as_inputs_all_inputs_as_internal", get_test_model_all_tensors_as_inputs_all_inputs_as_internal());
...
const auto dummy_test_model_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_2", get_test_model_2());
...
const auto dummy_test_model_all_inputs_as_internal_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_all_inputs_as_internal_2", get_test_model_all_inputs_as_internal_2());
...
const auto dummy_test_model_all_tensors_as_inputs_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_all_tensors_as_inputs_2", get_test_model_all_tensors_as_inputs_2());
...
const auto dummy_test_model_all_tensors_as_inputs_all_inputs_as_internal_2 = TestModelManager::get().add("conv_1_h3_w2_SAME_all_tensors_as_inputs_all_inputs_as_internal_2", get_test_model_all_tensors_as_inputs_all_inputs_as_internal_2());
