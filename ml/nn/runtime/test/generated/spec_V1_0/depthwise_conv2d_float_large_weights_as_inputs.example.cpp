...
namespace generated_tests::depthwise_conv2d_float_large_weights_as_inputs {
...
const auto dummy_test_model = TestModelManager::get().add("depthwise_conv2d_float_large_weights_as_inputs", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("depthwise_conv2d_float_large_weights_as_inputs_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
