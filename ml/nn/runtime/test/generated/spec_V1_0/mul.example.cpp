...
const auto dummy_test_model = TestModelManager::get().add("mul", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("mul_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
