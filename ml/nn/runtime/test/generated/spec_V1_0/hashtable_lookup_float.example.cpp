...
const auto dummy_test_model = TestModelManager::get().add("hashtable_lookup_float", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("hashtable_lookup_float_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
