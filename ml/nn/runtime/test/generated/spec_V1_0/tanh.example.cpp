...
const auto dummy_test_model = TestModelManager::get().add("tanh", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("tanh_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
