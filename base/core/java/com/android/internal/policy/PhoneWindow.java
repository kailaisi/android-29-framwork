...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public PhoneWindow(Context context, Window preservedWindow,
        ...
        if (preservedWindow != null) {
            //快速重启activity机制，比如你的一个activity已经启动了，但是主题换了或者configuration变了，这里只需要重新加载资源和view，没必重新再执行DecorView的创建工作。
            //mDecor是activity的根View,其本质也是一个FrameLayout。如果这里没有初始化的话，会在setContentView中进行初始化
    ...
    private void installDecor() {
        ...
        if (mContentParent == null) {
            ...
            if (decorContentParent != null) {
                ...
                if (mTitleView != null) {
                    //如果设置了FEATURE_NO_TITLE属性，那么title设置隐藏
            ...
            //如果设置了FEATURE_ACTIVITY_TRANSITIONS属性，也就是转场动画
