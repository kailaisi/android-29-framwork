...
public class PackageParser {
    ...
    private Package parseBaseApk(File apkFile, AssetManager assets, int flags)
        ...
        try {
            ...
            //解析器打开ANDROID_MANIFEST_FILENAME（AndroidManifest.xml）文件
            parser = assets.openXmlResourceParser(cookie, ANDROID_MANIFEST_FILENAME);
            final Resources res = new Resources(assets, mMetrics, null);

            final String[] outError = new String[1];
            //进行AndroidManifest.xml文件的解析
    ...
    //校验“AndroidManifest.xml”文件的格式，并且找到文件的包名
    private static Pair<String, String> parsePackageSplitNames(XmlPullParser parser,
        ...
        //AndroidManifest.xml没有<manifest>标识
    ...
    private boolean parseBaseApplication(Package owner, Resources res,
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            String tagName = parser.getName();
            //遍历解析Activity、receiver、service、provider等
