    ...
    private static final Singleton<IActivityTaskManager> IActivityTaskManagerSingleton =
            new Singleton<IActivityTaskManager>() {
                ...
                protected IActivityTaskManager create() {
                    //IPC机制，获取通过系统的  ServiceManager 类  获取到一个IBinder对象并转换成  IActivityManager  也就是说我们上面的
                    //最终获取的就是一个 IActivityManager  ，最终的启动流程在 IActivityManager  这个里面。
                    //这个代理对象的最终实现方法都在实现了IActivityTaskManager.Stub类中，也就是ActivityTaskManagerService类
