 ...
 */
 //ActivityDisplay表示一个屏幕，Android支持三种屏幕：主屏幕，外接屏幕（HDMI等），虚拟屏幕（投屏）。
 //一般情况下，即只有主屏幕时，ActivityStackSupervisor与ActivityDisplay都是系统唯一。
 //持有着当前屏幕上显示的ActivityStack列表信息。
class ActivityDisplay extends ConfigurationContainer<ActivityStack>
     ...
     */
     //获取持有焦点的activitystack信息，即栈顶的activityStack
